  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Create viral, click-worthy thumbnails with AI</p>
      </div>
      ...
      {result && (
        <Card className="p-6 border animate-in fade-in slide-in-from-bottom-4 duration-500">
          <h2 className="text-sm font-semibold text-foreground mb-4">Generated Thumbnail</h2>
